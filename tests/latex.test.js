...
test('latex-formatting', t => {
  //1 tick
  // var have = wtf(`i 'think' so`).toLatex();
  // var want = `i 'think' so`;
  // t.equal(tidy(have), tidy(want), 'one-tick');
  // //
  // //   //2 ticks
  // have = wtf(`i ''think'' so`).toLatex();
