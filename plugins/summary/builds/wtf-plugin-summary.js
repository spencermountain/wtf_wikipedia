...
(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.wtfSummary = factory());
})(this, (function () { 'use strict';

	var commonjsGlobal = typeof globalThis !== 'undefined' ? globalThis : typeof window !== 'undefined' ? window : typeof global !== 'undefined' ? global : typeof self !== 'undefined' ? self : {};

	var compromise = {exports: {}};
	...
	(function (module, exports) {
	  (function (global, factory) {
	    ...
	    var _id = makeId$2; //approximate visual (not semantic or phonetic) relationship between unicode and ascii characters
	    ...
	    var _03Misc = {}; // Based on  tad-lispy /node-damerau-levenshtein
	    ...
	    const fuzzyMatch = function (strA, strB) {
	      let minLength = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 3;
	    ...
	    _02Text.text = function () {
	      let options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
	      let isFirst = arguments.length > 1 ? arguments[1] : undefined;
	      let isLast = arguments.length > 2 ? arguments[2] : undefined;
	    ...
	    _05Json.json = function () {
	      let options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
	      let world = arguments.length > 1 ? arguments[1] : undefined;
	      let res = {}; // text data
	    ...
	    var _04PostProcess = postProcess$3; // suffixes:     ? ] + * $ {2,6} ~
	    //     [\?\]\+\*\$~]*
	    // prefixes: ! [ ^
	    //     [\!\[\^]*
	    ...
	    */
	    ...
	    const postProcess$2 = function (tokens) {
	    ...
	    const matchAll$2 = function (p, regs) {
	      let matchOne = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
	    ...
	    match.match = function (regs) {
	      let justOne = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
	      let matches = matchAll(this, regs, justOne); //make them phrase objects

	      matches = matches.map(_ref3 => {
	        let {
	          match,
	          groups
	        } = _ref3;
	    ...
	    var _linkTerms = linkTerms$2; // Ignore periods/questions/exclamations used in acronyms/abbreviations/numbers, etc.
	    ...
	    var addIrregulars_1 = addIrregulars$1; //used in noun.inflect, and also in the lexicon.
	    ...
	    const conjugate$4 = function () {
	      let inf = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
	      let world = arguments.length > 1 ? arguments[1] : undefined;
	    ...
	    const buildTree = function (termList) {
	    ...
	    _01Replace.replaceWith = function (replace) {
	    ...
	    var _02Punctuation = checkPunctuation; // order matters.
	    ...
	    var _03Prefixes = checkRegex$1; //built using wordnet, by spencer kelly.
	      ...
	      if (endsWith.hasOwnProperty(char) === true) {
	        ...
	        for (let r = 0; r < regs.length; r += 1) {
	          if (regs[r][0].test(str) === true) {
	            term.tagSafe(regs[r][1], "endReg ".concat(char, " #").concat(r), world);
	            break;
	          }
	        }
	      }
	    ...
	    var _04Suffixes = checkRegex; //faster than
	    ...
	    var _01Init = lookups; //basically, a little-bit better than the noun-fallback
	    ...
	    var _04Plurals = checkPlural; //todo remove/normalize plural forms
	    ...
	    const dates = "(".concat(ambig$4.personDate.join('|'), ")");
	    let list$4 = [// ==== Holiday ====
	    {
	    ...
	    const adjectives$1 = "(".concat(ambig$3.personAdjective.join('|'), ")");
	    ...
	    const adjectives = "(".concat(ambig$2.adverbAdjective.join('|'), ")");
	    ...
	    const verbs = "(".concat(ambig$1.personVerb.join('|'), ")");
	    ...
	    const ambig = _ambig;
	    const nouns = "(".concat(ambig.personNoun.join('|'), ")");
	    const months = "(".concat(ambig.personMonth.join('|'), ")");
	    const places = "(".concat(ambig.personPlace.join('|'), ")");
	    let list = [// ==== Honorific ====
	    {
	    ...
	    var toPossessive_1 = toPossessive$1; // pull these apart, if necessary
	    ...
	    var toInfinitive_1 = toInfinitive$2; // we walk -> plural
	    ...
	    var toNegative_1 = toNegative$1; // get the prior verb most-likely doing this action
	    ...
	    function instance(worldInstance) {
	      ...
	      const nlp = function () {
	        let text = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
	        let lexicon = arguments.length > 1 ? arguments[1] : undefined;
	...
	const nlp$2 = compromise.exports;
	...
	const nlp$1 = compromise.exports;
