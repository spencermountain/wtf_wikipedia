...
(function (global, factory) {
  ...
  var citation = ['atsauce', 'chú thích', 'cit', 'cita testo', 'citácia harvard', 'citat', 'citat3', 'citation', 'cite', 'citim', 'cito', 'cytuj', 'erreferentzia', 'iomradh', 'kaynak', 'kilde', 'obra citada', 'tzita testu', 'viide', 'наведување', 'উদ্ধৃতি', 'ကိုးကားခြင်း', '인용'];

  var cite_book = ['bókaheimild', 'book reference', 'chú thích sách', 'ċita ktieb', 'cita libro', 'cita libru', 'cita llibru', 'citace monografie', 'citácia knihy', 'citaĵo el libro', 'citar lhibro', 'citar libro', 'citar livro', 'citat carte', 'citaziuni di testu', 'cite book', 'cite book.', 'cité un lìber', 'citeer boek', 'citiranje knjiga', 'cytuj książkę', 'cytuj ksiōnżkã', 'enmyslioar', 'girjegáldu', 'grāmatas atsauce', 'hivatkozás/könyv', 'iomradh leabhar', 'kilde bog', 'kilde bok', 'kirjaviite', 'kitap kaynağı', 'kjelde bok', 'lidɐraduur', 'literatur', 'literatura', 'navedi knjigo', 'ouvrage', 'ôvra', 'ref-llibre', 'tzita libru', 'кітап', 'наведена книга', 'צייגט בוך', 'استشهاد بكتاب', 'حوالہ کتاب', 'کیتاب قایناقلاماسی', 'ڪتابن مان حوالا', 'یادکرد', 'स्रोत पुस्तक', 'বই উদ্ধৃতি', '서적 인용', '引書'];

  var cite_journal = ['article', 'chú thích tạp chí', 'cita pubblicazione', 'ċita pubblikazzjoni', 'cita publicación', 'cita publicación periódica', 'cita publicasion', 'citácia periodika', 'citaĵo el gazeto', 'citar periódico', 'citat revistă', 'cite aldizkari', 'cite journal', "cité n'arvista", 'cite paper', 'citeer journal', 'citiranje časopisa', 'cytuj news', 'cytuj pismo', 'dergi kaynağı', 'iomradh iris', 'lehtiviite', 'luaigh foilseachán', 'navedi revijo', 'publikācijas atsauce', 'ref-publicació', 'revista', 'tzita publicatzione', 'макъала', 'наведено списание', 'статья', 'ыстатыйа', 'استشهاد بدورية أكاديمية', 'بیرخستنەوەی گۆڤار', 'حوالہ رسالہ', 'जर्नल स्रोत', 'সাময়িকী উদ্ধৃতি', '저널 인용'];

  var cite_web = ['chú thích web', 'cita web', 'ċita web', 'citace elektronické monografie', 'citácia elektronického dokumentu', 'citaĵo el la reto', 'citar web', 'citat web', 'cité la ragnà', 'cite web', 'cite web', 'cite web öömrang', 'citeer web', 'citeweb', 'citiranje weba', 'cito web', 'cytuj strōnã', 'cytuj stronę', 'iomradh lìon', 'kilde www', 'lien web', 'ligam web', 'lim vouèbe', 'lua idirlín', 'navedi splet', 'neahttagáldu', 'ref-web', 'tīmekļa atsauce', 'tzita web', 'vefheimild', 'verkkoviite', 'web kaynağı', 'наведена мрежна страница', 'спасылка', 'цитат уеб', 'צייגט וועב', 'بیرخستنەوەی وێب', 'حوالہ ویب', 'حوالو ويب', 'مرجع ويب', 'وب قایناقلاماسی', 'संकेतस्थळ स्रोत', 'ওয়েব উদ্ধৃতি', 'వెబ్ మూలము', 'උපන්‍යාස වෙබ්', '웹 인용', '引網'];

  var commons_cat = ['catcómhaoin', 'categorìa ëd commons', 'comincat', 'commons', 'commons cat', 'commons categories', 'commons category', 'commons kategori', 'commons kategoriýa', 'commons-kategorie', 'commonscat', 'commonscat', 'commonscat ', 'commonsi kategooria', 'commonskat', 'commonskat', 'communiacat', 'katégori commons', 'kategori commons', 'kategorija v zbirki', 'thể loại commons', 'vikianbar kateqoriyası', 'vikikrātuves kategorija', 'викианбор-гурӯҳ', 'категорија на остави', 'ризница-врска', 'վիքիպահեստ կատեգորիա', 'קאמאנסקאט', 'آمبار بؤلمه', 'پۆلی کۆمنز', 'تصنيف كومنز', 'تصنيف كومونز', 'رده انبار', 'زمرہ کومنز', 'ڪومنز زمرو', 'कमन्सश्रेणी', 'कॉमन्स वर्ग', 'कॉमन्स श्रेणी', 'कॉमंस श्रेणी', 'কমন্স থাক', 'কমন্স বিষয়শ্রেণী', 'ਕਾਮਨਜ਼ ਸ਼੍ਰੇਣੀ', 'කොමන්ස්ප්‍රවර්ග', 'คอมมอนส์-หมวดหมู่', '위키공용분류', '同享類'];
