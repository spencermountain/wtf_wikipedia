import ignore from './_ignore.ts'
import { isInfobox, fmtInfobox } from './_infobox.ts'
import templates from '../custom/index.ts'
import toJSON from './toJSON/index.ts'
import { isArray, isObject } from '../../_lib/helpers.ts'
