...
const wtf = window.wtf // latest version loaded dynamically




// chunk array into smaller arrays ['a','b','c','d'] => [['a','b'],['c','d']]
function chunk(list = null, chunkSize = 5) {
  let result = [];
...
async function fetchNicely(urlOrUrlList = null,
  options = {},
  groupSize = 5) {
...
function formatNumber(num, minFractDigits = 0) {
